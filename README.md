...
- 1.1.0, 1.2.0, 1.3.0, 1.4.0, 1.4.1, 1.5.0, 1.6.0, 1.7.0, 1.8.0, 1.8.1, 1.8.2, 1.8.3, 1.8.4
...
configuration.pkg.ibm.crossplane.io/ibm-crossplane-bedrock-shim-config   True        True      icr.io/cpopen/cpfs/ibm-crossplane-bedrock-shim-config:1.8.3   59s
```
